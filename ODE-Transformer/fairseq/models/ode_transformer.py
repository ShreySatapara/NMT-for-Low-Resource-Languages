...
@register_model_architecture('ode_transformer','ode_transformer_lm_4x')
def ode_transformer_lm_4x(args):
...
@register_model_architecture('ode_transformer','ode_transformer_3_layer')
def ode_transformer_3_layer(args):
    args.encoder_layers = getattr(args, 'encoder_layers', 3)
    args.decoder_layers = getattr(args, 'decoder_layers', 3)
    base_architecture(args)


@register_model_architecture('ode_transformer','ode_transformer_3_layer_big')
def ode_transformer_3_layer_big(args):
    args.encoder_layers = getattr(args, 'encoder_layers', 3)
    args.decoder_layers = getattr(args, 'decoder_layers', 3)
